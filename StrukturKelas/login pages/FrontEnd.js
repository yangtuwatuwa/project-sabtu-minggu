let NamaKelas1 = ["adhyaksa","afifah","ahmad","al-ayubi","alfin","andhika","azka"];
let NamaKelas2 = ["bagus", "chelsea","daffa","dewangga","eza","fahri","galang"];
...
let NamaKelas5 = ["reno","rizky","sakha","silvester","wildan","syafira"];
